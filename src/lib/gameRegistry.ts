...
export const CHARACTERS: CharacterDef[] = [
  ...
  },
  {
    ...
    name: 'Midas Gold',
    nameAr: 'ميداس الذهبي',
    description: 'The golden king — everything he touches turns to gold. S12 BP Tier 100.',
    rarity: 'legendary',
    price: 1000,
    currency: 'k_gems',
    colors: { primary: '#c8a92c', secondary: '#f5d442', accent: '#ffe066', emissive: '#ffd700' },
    armorStyle: 'heavy',
  },
  {
    id: 'marigold',
    name: 'Marigold',
    nameAr: 'ماريغولد',
    description: 'Female counterpart of Midas with golden elegance and deadly precision.',
    rarity: 'epic',
    price: 600,
    currency: 'k_gems',
    colors: { primary: '#d4a843', secondary: '#f0cc5b', accent: '#fff1a8', emissive: '#ffcc00' },
    armorStyle: 'medium',
  },
  {
    id: 'glow_phantom',
    name: 'Glow Phantom',
    nameAr: 'غلو فانتوم',
    description: 'Ethereal glowing warrior with radiant energy aura.',
    rarity: 'rare',
    price: 400,
    currency: 'k_coins',
    colors: { primary: '#1a1a3e', secondary: '#2a2a5e', accent: '#88aaff', emissive: '#6688ff' },
    armorStyle: 'light',
  },
];
...
export const WEAPON_CATALOG: WeaponDef[] = [
  ...
  },
  {
    ...
    spread: 0.05,
    pelletsPerShot: 1,
    description: 'Iconic heavy pistol with devastating stopping power.',
    colors: { body: '#c0c0c0', accent: '#888888', emissive: '#ffaa00' },
  },
  {
    id: 'glock_17',
    name: 'Glock-17',
    ...
    spread: 0.04,
    pelletsPerShot: 1,
    description: 'Reliable standard-issue sidearm with quick draw.',
    colors: { body: '#1a1a1a', accent: '#333333', emissive: '#ffffff' },
  },
  {
    id: 'm4a4_thunder',
    name: 'M4A4 Thunder',
    ...
    spread: 0.035,
    pelletsPerShot: 1,
    description: 'Enhanced M4 variant with superior accuracy and thunder-themed skin.',
    colors: { body: '#2a2a3a', accent: '#4488ff', emissive: '#2266ff' },
  },
  {
    id: 'sniper_elite',
    name: 'Sniper Elite',
    ...
    spread: 0.006,
    pelletsPerShot: 1,
    description: 'Ultra-precision sniper rifle for the deadliest marksmen.',
    colors: { body: '#0a0a0a', accent: '#222222', emissive: '#ff0044' },
  },
  {
    id: 'usp_shadow',
    name: 'USP Shadow',
    ...
    spread: 0.03,
    pelletsPerShot: 1,
    description: 'Silenced tactical pistol with pinpoint accuracy.',
    colors: { body: '#1a1a2e', accent: '#444466', emissive: '#8844ff' },
  },
];
